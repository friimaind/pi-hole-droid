...
*Please note:* Google Play Store is temporary unavailable, in the meantime you can **get the latest APK** directly from [here](https://github.com/friimaind/pi-hole-droid/releases/latest) or [IzzyOnDroid F-Droid repository](https://f-droid.org/en/packages/friimaind.piholedroid/)
